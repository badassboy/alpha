            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="position-relative mb-3">
                        ...
                        <img class="img-fluid w-100" src="admin/<?php echo $row['picture']; ?>" style="object-fit: cover; height: 100%; width: 100%; ">
                        <div class="bg-white border border-top-0 p-4">
                            <div class="mb-3">
                                <a class="badge badge-primary text-uppercase font-weight-semi-bold p-2 mr-2"
                                    href="">Business</a>
                                <a class="text-body" href=""><?php echo $row['news_date']; ?></a>
                            </div>
                ...
                <div class="col-lg-4">
                   ...
                   <!--  <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="bg-white text-center border border-top-0 p-3">
                            <p>Enter email to  subscribe to daiy news</p>
